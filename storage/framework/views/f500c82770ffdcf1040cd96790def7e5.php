                            ...
                            <div id="div_parent_id" class=" flex    px-4   w-full lg:w-auto mt-3 lg:mt-0 ml-auto  ">
                                ...
                                <select id="wh_id" name="wh_id" class="form-control" aria-label="Default select example"   >
                                    <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($wh->id); ?>" <?php echo e($ic->wh_id==$wh->id?'selected':''); ?>><?php echo e($wh->title); ?></option>
...
$(document).ready(function(){ //Your code here 
    ...
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("inventorycheck.getProductList")); ?>',
        data: {
            ic_id: <?php echo e($ic->id); ?>,
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('inventorycheck.update',$ic->id)); ?>", // Replace with your actual server endpoint URL
        method: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/inventorycheck/edit.blade.php ENDPATH**/ ?>
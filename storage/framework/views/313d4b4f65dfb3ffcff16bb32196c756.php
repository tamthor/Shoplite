                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <div class=" mt-3 ">
                                ...
                                <div class="flex">
                                    <input type="text" id='supplier_search' value="<?php echo e($supplier->full_name); ?>"
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3"> 
                                ...
                                <input type="number" id='discount_amount'  value="<?php echo e($discount_amount); ?>"
                            ...
                            <div class="mt-3">
                                ...
                                <input  id='paid_amount' type="number" name='paid_amount' value="<?php echo e($paid_amount); ?>"
                                class="form-control py-3 mt-2 " placeholder="số tiền đã thanh toán">
                                <input type='hidden' value='<?php echo e($final_amount); ?>' id='totalcost'/>
                            </div>
                            <div class="mt-3">
                                <label style="min-width:50px  " class="form-select-label" for="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/warehouseins/create_e.blade.php ENDPATH**/ ?>
...
<ul>
    ...
    <li>
        ...
        <ul class="<?php echo e(($active_menu =='pro_add'|| $active_menu=='pro_list' || $active_menu =='cat_add'|| $active_menu=='cat_list' || $active_menu =='brand_list' || $active_menu == 'brand_list')?'side-menu__sub-open':''); ?>">
            <li>
                <a href="<?php echo e(route('pets.index')); ?>" class="side-menu <?php echo e($active_menu=='pro_list'?'side-menu--active':''); ?>">
                    <div class="side-menu__icon"> <i data-lucide="list"></i> </div>
                    <div class="side-menu__title">Danh sách thú cưng</div>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('pets.create')); ?>" class="side-menu <?php echo e($active_menu=='pro_add'?'side-menu--active':''); ?>">
                    <div class="side-menu__icon"> <i data-lucide="plus"></i> </div>
                    <div class="side-menu__title"> Thêm thú cưng</div>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('pet_category.index')); ?>" class="side-menu <?php echo e($active_menu=='cat_list'?'side-menu--active':''); ?>">
                    <div class="side-menu__icon"> <i data-lucide="archive"></i> </div>
                    <div class="side-menu__title"> Danh sách danh mục </div>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('pet_category.create')); ?>" class="side-menu <?php echo e($active_menu=='cat_add'?'side-menu--active':''); ?>">
                    <div class="side-menu__icon"> <i data-lucide="plus"></i> </div>
...
</nav><?php /**PATH D:\Shoplite\shoplite\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>
...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="<?php echo e(route('user.savestoretouser')); ?>">
                <?php echo csrf_field(); ?>
                <div class="intro-y box p-5">
                    ...
                    <div>
                        ...
                        <input id="paid_amount" name="paid_amount" value = "<?php echo e($supplier->budget); ?>"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/users/storetouser.blade.php ENDPATH**/ ?>
...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="<?php echo e(route('pets.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm thú cưng</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang <?php echo e($pets->currentPage()); ?> trong <?php echo e($pets->lastPage()); ?> trang</div>
                ...
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    <select name="cat_id" id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php echo e($cat_id==$cat->id?'selected':''); ?>><?php echo e($cat->name); ?></option>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>
                            <a href="<?php echo e(route('product.show',$pet->id)); ?>" class="font-medium  "><?php echo e($pet->name); ?></a> 
                        </td>
                            ...
                            <div class="flex">
                                <?php if($pet->image): ?>
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="tooltip rounded-full" src="<?php echo e($pet->image); ?>" alt="Pet Image"/>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                            <?php echo e($pet->price); ?>

                        </td>
                        
                        <td>
                            <?php echo e($pet->category_id!=null ? \App\Models\PetCategory::where('id',$pet->category_id)->value('name'):''); ?>   
                        </td>
                            ...
                            <div class="flex justify-center items-center">
                                <div class="dropdown py-3 px-1 ">  
                                    ...
                                    <div class="dropdown-menu w-40"> 
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('pets.edit',$pet->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a></li>            
                                        <li>
                                            <form action="<?php echo e(route('pets.destroy',$pet->id)); ?>" method = "post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('delete'); ?>
                                                <a class=" dropdown-item flex items-center text-danger dltBtn" data-id="<?php echo e($pet->id); ?>" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                                            </form>
                                        </li>
                                        </ul>
                                    </div> 
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                <?php echo e($pets->links('vendor.pagination.tailwind')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Shoplite\shoplite\resources\views/backend/pets/index.blade.php ENDPATH**/ ?>
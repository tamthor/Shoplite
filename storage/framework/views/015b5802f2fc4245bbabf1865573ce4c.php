                        ...
                        <div class="px-1 py-2 sm:px-1 sm:py-2">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="mt-2"> Mã: <span class="font-medium"><?php echo e($warehouseout->code); ?></span> </div>
                                    <div class="mt-2"> Mã điện tử: <span class="font-medium"><?php echo e($warehouseout->uiid); ?></span> </div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/warehouseouts/show.blade.php ENDPATH**/ ?>
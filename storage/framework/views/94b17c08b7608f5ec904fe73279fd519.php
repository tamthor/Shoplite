                    ...
                    <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                        ...
                        <div class="col-span-12 lg:col-span-12">
                            <table id="myTable" class="display table" style="width:100%">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $wis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td> <?php echo e($i); ?> </td>
                                        <td><?php echo e(substr($wi->created_at,0,10)); ?> </td>
                                        <td> <?php echo e($wi->code); ?> </td>
                                        <td> <?php echo e(number_format($wi->final_amount,0,'.',',')); ?> </td>
                                        <td class='text-center'> 
                                            <table class='table'>
                                                ...
                                                <?php $__currentLoopData = $wi->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/suppliers/chitietmuahang.blade.php ENDPATH**/ ?>
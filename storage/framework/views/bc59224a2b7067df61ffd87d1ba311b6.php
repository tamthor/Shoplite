                            ...
                            <div class="flex justify-center items-center">
                                <div class="dropdown py-3 px-1 ">  
                                    ...
                                    <div class="dropdown-menu w-40"> 
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('inventory.viewproduct',$item->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>nhập xuất kho</a></li>

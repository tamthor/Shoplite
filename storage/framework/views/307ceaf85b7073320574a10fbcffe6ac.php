                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="mt-2"> Mã: <span class="font-medium"><?php echo e($warehousetrans->id); ?></span> </div>
                                    <div class="mt-1">Ngày lập: <?php echo e($warehousetrans->created_at); ?></div>
                                    <div class="form-help">
                                        <?php echo e($warehousetrans->created_at!=$warehousetrans->updated_at?"Điều chỉnh: ".$warehousetrans->updated_at:""); ?>
                                    ...
                                    <td style="width: 50%" class="text-left">
                                        <div >
                                            ...
                                            <div class="text-lg font-medium text-primary mt-2">
                                                <?php echo e(\App\Models\Warehouse::where('id',$warehousetrans->wh_id1)->value('title')); ?>

                                            </div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousetrans->vendor_id1)->value('full_name')); ?></div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousetrans->vendor_id1)->value('phone')); ?></div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div >
                                            ...
                                            <div class="text-lg font-medium text-primary mt-2">
                                                <?php echo e(\App\Models\Warehouse::where('id',$warehousetrans->wh_id2)->value('title')); ?>

                                            </div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousetrans->vendor_id2)->value('full_name')); ?></div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousetrans->vendor_id2)->value('phone')); ?></div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="overflow-x-auto">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php if(isset($wi->series) && $wi->series!= ''): ?>
                                        
                                    
                                    <tr>
                                        <td colspan='5'>
                                           Seri:  <?php echo e($wi->series); ?>
                                ...
                                <tfooter>
                                    <tr>
                                        ...
                                        <td class="text-right font-medium">
                                            <?php echo e(number_format($warehousetrans->total, 0, '.', ',')); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\shop4\resources\views/backend/warehousetransfers/show.blade.php ENDPATH**/ ?>
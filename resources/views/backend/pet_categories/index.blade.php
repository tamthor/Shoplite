...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('pet_category.create')}}" class="btn btn-primary shadow-md mr-2">Thêm danh mục</a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td>
                            <a href="" class="font-medium whitespace-nowrap">{{$item->description}}</a> 
                        </td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('pet_category.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <form action="{{route('pet_category.destroy',$item->id)}}" method = "post">
                                    @csrf
                                    @method('delete')

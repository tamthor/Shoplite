...
<ul>
    ...
    <li>
        ...
        <ul class="{{($active_menu =='pro_add'|| $active_menu=='pro_list' || $active_menu =='cat_add'|| $active_menu=='cat_list' || $active_menu =='brand_list' || $active_menu == 'brand_list')?'side-menu__sub-open':''}}">
            <li>
                <a href="{{route('pets.index')}}" class="side-menu {{$active_menu=='pro_list'?'side-menu--active':''}}">
                    <div class="side-menu__icon"> <i data-lucide="list"></i> </div>
                    <div class="side-menu__title">Danh sách thú cưng</div>
                </a>
            </li>
            <li>
                <a href="{{route('pets.create')}}" class="side-menu {{$active_menu=='pro_add'?'side-menu--active':''}}">
                    <div class="side-menu__icon"> <i data-lucide="plus"></i> </div>
                    <div class="side-menu__title"> Thêm thú cưng</div>
                </a>
            </li>
            <li>
                <a href="{{route('pet_category.index')}}" class="side-menu {{$active_menu=='cat_list'?'side-menu--active':''}}">
                    <div class="side-menu__icon"> <i data-lucide="archive"></i> </div>
                    <div class="side-menu__title"> Danh sách danh mục </div>
                </a>
            </li>
            <li>
                <a href="{{route('pet_category.create')}}" class="side-menu {{$active_menu=='cat_add'?'side-menu--active':''}}">
                    <div class="side-menu__icon"> <i data-lucide="plus"></i> </div>

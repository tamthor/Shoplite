...
Route::group( ['prefix'=>'admin/','middleware'=>'auth' ],function(){
  ...
  Route::get('comment_search',[\App\Http\Controllers\CommentController::class,'commentSearch'])->name('comment.search');
    ...
    // Route::post('pet-upload', [\App\Http\Controllers\FilesController::class, 'petUpload' ])->name('upload.pet');

    // pet_category section
    Route::resource('pet_category', \App\Http\Controllers\PetCategoryController::class);
